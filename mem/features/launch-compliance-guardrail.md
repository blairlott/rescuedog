...
description: Hard content rules every blog draft, ad, and CMS-authored copy must pass before publish. "50% of profits" is allowlisted; "portion of every bottle" is forbidden.
type: constraint
---
# 7-Rule Launch Compliance Guardrail
...
2. **No quantified impact claims** unless they appear in the approved-fact allowlist. Forbid generic counters/totals: `/\d[\d,]*\s*(homes|dogs|meals|bottles|rescues)\s*(funded|saved|served|donated|placed)/i`. Allowed exceptions: "Partnered with 225 rescue organizations" and "50% of profits" (programmatic giveback commitment, financially verified).
...
4. **Mission framing intact.** Must not contradict "helping dogs find their forever home." Forbid: `/(donates?|gives?|contributes?|sends?|routes?)\s+a\s+portion\s+of\s+every\s+(bottle|sale|order|purchase)/i` (Blair directive 2026-05). Replace with "50% of profits" framing.
...
- "50% of profits" / "Half of every dollar" — programmatic giveback commitment to 501(c)(3) dog-rescue partners. Approved by Blair 2026-05.
...
## Status
LOCKED 2026-05-21. Blair-approved. "50% of profits" stays; "portion of every bottle" is forbidden site-wide (sitewide sweep completed: jsonLd.tsx, PoliciesPage, WineThatGivesBackPage, wpMockData).