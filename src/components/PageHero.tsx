...
export function PageHero({ title, subtitle, backgroundImage, compact }: PageHeroProps) {
  return (
    <section
      className={`relative flex items-center justify-center text-center overflow-hidden ${compact ? "py-16 md:py-20" : "py-20 md:py-28"}`}
      style={
        backgroundImage
          ? {
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4">
        <h1 className="text-3xl md:text-5xl font-bold text-primary-foreground tracking-brand uppercase mb-3">
          {title}
        </h1>
        {subtitle && (
