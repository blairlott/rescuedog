...
const teamMembers = [
  {
    ...
    image: "https://rescuedogwines.com/wp-content/uploads/2023/09/laura-blair-lott.jpeg",
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="relative h-[50vh] min-h-[400px] flex items-center bg-foreground">
          <div className="absolute inset-0 bg-[url('https://rescuedogwines.com/wp-content/uploads/2023/09/laura-blair-lott.jpeg')] bg-cover bg-center opacity-50" />
          <div className="relative container mx-auto px-4 text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-primary-foreground mb-4">About Rescue Dog Wines</h1>
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-foreground leading-relaxed mb-4">
                  During this period of exploring many of California's wine regions, it dawned on the Lotts that they could combine their two passions—and Rescue Dog Wines was born!
                </p>
                <p className="text-foreground leading-relaxed">
                  Fast forward several years and Rescue Dog Wines is pleased to offer a full portfolio of wines, many from our neighbors' sustainable vineyards or our <a href="https://www.lodirules.org/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Lodi Rules Certified Green</a> vineyard in Acampo, California. We're proud that 50% of our profits support rescue organizations.
                </p>
              </div>
              <div className="aspect-[4/3] bg-secondary overflow-hidden">
                <img
                  src="https://rescuedogwines.com/wp-content/uploads/2023/09/laura-blair-lott.jpeg"
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-foreground leading-relaxed mb-8">
                Rescue Dog Wines prefers to donate wine for fundraising. We tend to donate locally in California or in other states where we have distribution, so our partners can donate on our behalf. If you're really close by, our team can potentially show up and pour our wines at your rescue organization's event!
              </p>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div className="aspect-[4/3] bg-secondary overflow-hidden">
                <img
                  src="https://rescuedogwines.com/wp-content/uploads/2023/12/rdw-vineyard-5.jpg"
        ...
        <section className="py-16 bg-secondary">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-muted-foreground mb-8 max-w-lg mx-auto">
              If you'd like for us to consider your rescue organization for a donation, please complete our Donation Request form.
            </p>
