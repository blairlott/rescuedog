...
const PRESETS: Record<string, string> = {
  ...
  hero_16x9: "Reframe and extend this image into a true cinematic 16:9 landscape hero banner (≥1920x1080) for Rescue Dog Wines. Outpaint left/right edges as needed so the subject is naturally centered or rule-of-thirds composed with generous negative space for overlay text on the left third. Preserve the original subject identity (dog/wine/people), pose, and lighting direction. Warm editorial color grading, photographic realism, no text, no logos, no borders.",
