...
REVOKE ALL ON FUNCTION public.setup_gated_cron_jobs(text) FROM public, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.setup_gated_cron_jobs(text) TO service_role;